...
Libraries are more than collections — they are the infrastructure of an informed society. My work explores how libraries serve diverse publics: from open knowledge platforms to feminist libraries, from services for the visually impaired to unconditional access for homeless populations. These are questions I have explored long before joining [Kula](https://www.uvic.ca/library/about-us/kula-academy/index.php) — and that now define my work there.
→ [Fake Science … and how libraries can intervene](https://nbn-resolving.org/urn:nbn:de:0290-opus4-168032) (German publication)

### Library Futures

For as long as I have been a professional in the field of knowledge preservation and organization, I have been fascinated by the question of what tomorrow's libraries will look like. At [Kula: Library Futures Academy](https://www.uvic.ca/library/about-us/kula-academy/index.php), I am part of a team that works on building that future.
One of my publications from 2015 is a futurology that explores the matter in a playful manner (German publication):
→ Der Stipendienantrag — Do or die! In: *Zeitreisen in die bibliothekarische Zukunft: 1914–2014–2114* (ISBN 978-3-936960-85-3, print only)
...
Libraries are built on strong values — open access, inclusion, intellectual freedom. But how well does the profession live up to them? My research keeps asking that question. I have examined library engagement with the [UN Sustainable Development Goals](https://sdgs.un.org/goals) and whether the profession's commitment to social inclusion holds up in practice — particularly for homeless populations. My master's thesis investigated how librarians navigate the tensions between professional ethics and the realities of academic self-publishing. This critical lens drives my work: not to undermine the profession, but to strengthen it.
→ [Homeless People as Library Patrons](https://doi.org/10.18452/20199) (German publication)

### Scholarly Communication

My research examines how scholars publish and how libraries can help them navigate an increasingly complex publishing landscape. I have published on how libraries help scholars resist predatory publishing and fight misinformation, and my master's thesis analyzed how the library profession engages with academic self-publishing.
→ [Fake Science … and how libraries can intervene](https://nbn-resolving.org/urn:nbn:de:0290-opus4-168032) (German publication)